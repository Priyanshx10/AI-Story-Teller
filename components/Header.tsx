...
function Header() {
  return (
    <header className='relative text-center p-16'>
        <Link href="/">
            <h1  className='text-6xl font-black'>Astro Story Teller</h1>
 ...
 {/*Nav Icons */}
        <div className='absolute -top-5 right-5 flex space-x-2'>
            <Link href="/">
                <FilePen className = "w-8 h-8 lg:10 lg:h-10 mx-auto text-sky-500
                    mt-10 border border-sky-500 p-2 rounded-md hover:opacity-50 cursor-pointer"/>
            </Link>
            <Link href="/stories">
                <BookOpen className = "w-8 h-8 lg:10 lg:h-10 mx-auto text-sky-500
                    mt-10 border border-sky-500 p-2 rounded-md hover:opacity-50 cursor-pointer"/>
            </Link>
